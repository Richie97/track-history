...
// <TeamID>.<bundle id>, from IOS_APP_ID in wrangler.jsonc vars; the fallback
// keeps the route harmless for forks that haven't set their own Team ID.
// (The Android equivalent, assetlinks.json, is a plain static file in
// public/.well-known/.)
