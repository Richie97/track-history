...
export const TRACKS = ["VIR Full", "Road Atlanta"];

// [start_date, days, club, group, track, best|null, notes|null, sessionBests[]]
export const EVENTS = [
  ["2025-04-12", 2, "Example Club", "Intermediate", "VIR Full", "2:15.4", "First weekend of the season.",
    ["2:19.80", "2:17.31", "2:15.4"]],
  ["2025-06-21", 2, "Example Club", "Intermediate", "VIR Full", "2:12.9", null,
    ["2:14.55", "2:12.9"]],
